...
from data_provider.tinkoff_api_get_all_candles.tinkoff_getallcandles import TinkoffAPIGetAllCandles
...
class DataProviderFactory:
    ...
    def new_factory(provider_name: str, *args, **kwargs) -> IDataProvider:
        match provider_name:
            ...
            case "TinkoffAPIGetAllCandles":
                return TinkoffAPIGetAllCandles(*args, **kwargs)
            case _:
                return TinkoffDownloaded(*args, **kwargs)
